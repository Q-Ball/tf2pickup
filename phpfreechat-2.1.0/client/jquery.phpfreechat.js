...
//var login = '<a href=\"http://steamcommunity.com/profile/' + $.cookie('steamid') + '\">' + $.cookie('nickname') + '</a>';
var login = $.cookie('nickname');
var password = '';
var email = '';
pfc.login({'login': login, 'password': password, 'email': email});
  ...
  pfc.loadHTML = function () {
    ...
    $(pfc.element).html(
      ...
      + (pfc.options.show_powered_by ?
        '          <p class="logo"><a href="http://www.phpfreechat.net" class="bt-powered" target="_blank"></a><a href="http://www.phpfreechat.net/donate"></a></p>' :
        '')
      + '        </div>'
      + '      </div>'
